...
<div className='homepage'>
     ...
     <div className='div-store'>
      ...
      <p className='store-text'>With an extensive collection of renowned national and international brands, we offer an unparalleled shopping experience that caters to every taste, style, and budget.</p>
     ...
     {category.map((category) => {
      ...
      <p className='category-text'>With an extensive collection of renowned national and international brands, we offer an unparalleled shopping experience that caters to every taste, style, and budget.</p>
      </div>
          </div>
     </div>
     <Slider />
